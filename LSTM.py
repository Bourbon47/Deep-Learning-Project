...
# 모델을 정의합니다.
model=Sequential()
model.add(LSTM(128, batch_input_shape=(1, 1, 45), return_sequences=False, stateful=True))
...
model1=Sequential()
model1.add(LSTM(128, batch_input_shape=(1, 1, 45), return_sequences=False, stateful=True))
